...
const TABS = [
  ...
  { key: 'Profile',   icon: (a: boolean) => <Ionicons name={a ? 'person' : 'person-outline'} size={22} color={a ? PRIMARY : MUTED} /> },
];
...
const styles = StyleSheet.create({
  ...
  tabBar: {
    ...
    paddingBottom: Platform_paddingBottom(),
    paddingTop: 8,
    alignItems: 'center',
    shadowColor: '#000',
    shadowOpacity: 0.08,
...
function Platform_paddingBottom() {
