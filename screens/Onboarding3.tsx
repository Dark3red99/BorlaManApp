    ...
    <SafeAreaView style={styles.onboardingSlide}>
      <View style={styles.illustrationContainer}>
        <BlurView intensity={20} style={styles.glassIconCard}>
          <Award color={Colors.primary} size={60} />
        </BlurView>
      </View>

      <View style={styles.textContainer}>
        <Text style={styles.title}>Earn Rewards</Text>
        <Text style={styles.description}>Get rewarded for your sustainable actions. Every recycle counts towards a better future.</Text>
      </View>
