...
import { Recycle, ChevronRight } from 'lucide-react-native';
    ...
    <SafeAreaView style={styles.onboardingSlide}>
      <View style={styles.illustrationContainer}>
        <BlurView intensity={20} style={styles.glassIconCard}>
          <Recycle color={Colors.primary} size={60} />
        </BlurView>
      </View>

      <View style={styles.textContainer}>
        <Text style={styles.title}>Recycling Made Simple</Text>
        <Text style={styles.description}>Make recycling easy and effective with our smart system. Sort your waste effortlessly.</Text>
      </View>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity style={styles.primaryBtn} onPress={() => navigation.navigate('Onboarding2')}>
